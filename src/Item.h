...
/// <para></para>
/// <see href="https://lua-api.factorio.com/latest/classes/LuaItemPrototype.html"/>
/// </summary>
struct Item
{
	enum ItemType
	...
	static ItemType MapStringToItemType(const string str);
	static ItemType MapStringToItemType(const wxString str);
	static bool MapStringToItemType(const string str, Item& type);
	static bool MapStringToItemType(const wxString str, Item& type);
